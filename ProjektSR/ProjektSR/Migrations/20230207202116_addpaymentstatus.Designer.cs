...
namespace ProjektSR.Migrations
{
    ...
    [Migration("20230207202116_addpaymentstatus")]
            ...
            modelBuilder.Entity("ProjektSR.Models.Order", b =>
                {
                    b.HasOne("ProjektSR.Models.Car", "Car")
                        .WithOne("Orders")
                        .HasForeignKey("ProjektSR.Models.Order", "CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjektSR.Models.User", "User")
                        .WithOne("Orders")
                        .HasForeignKey("ProjektSR.Models.Order", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjektSR.Models.Payment", b =>
                {
                    ...
                    b.HasOne("ProjektSR.Models.User", "User")
                        .WithOne("Payments")
                        .HasForeignKey("ProjektSR.Models.Payment", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
